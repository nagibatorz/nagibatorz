...
[![Gmail](https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:zhorzh@uw.edu)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/nagibatorez)
...
**[VirtualBrainLab/Pinpoint](https://github.com/VirtualBrainLab/Pinpoint)** — Neuroscience research tools
- 🔧 **Jackhammer Mode** — real-time motor control via Socket.IO API
- 📍 **External Tracking Pipeline** — probe position tracking system
- ✨ Code quality improvements with modern C# and type safety
...
- 🎓 **Kimura Family Scholar**
- 📚 **Bridge4Students Top Scholar**
- ⭐ **Balanced Man Scholarship** (Sigma Phi Epsilon)
- 🏆 **1st Place — UW Hackathon**
...
💡 *"Building software that advances science, one commit at a time."*
